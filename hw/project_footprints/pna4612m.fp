...
#Generated on 01/03/11 at 15:58:12
...
Element [ 0x0 "pna4612m.fp"  "pna4612m.fp"  ""  0  0  -12900   -12900   0   100   0x00 ] 
	(

	#Now adding Pins(Vias)
	#Pin [rX  rY  Annular-Ring  Copper-Clearance  Soldermask-Clearance  Drill-Size  "Name" "Number" SFlags]

	Pin [ 0 	0 	5799 	1600 	6799 	3799 	"1"  	"1" 	 0x0100 ]
	Pin [ 0 	10000 	5799 	1600 	6799 	3799 	"2"  	"2" 	 0x00 ]
	Pin [ 0 	20000 	5799 	1600 	6799 	3799 	"3"  	"3" 	 0x00 ]

	#Now adding Silkscreen lines
	#ElementLine [X1 Y1 X2 Y2 Thickness] 

	ElementLine [ -19148 		-4900 		4900 		-4900 		1000 ]
	ElementLine [ -19148 		-4900 		-19148 		24900 		1000 ]
	ElementLine [ 4900 		-4900 		4900 		24900 		1000 ]
	ElementLine [ -19148 		24900 		4900 		24900 		1000 ]
...
#%date_generated=01/03/11   15:58:12;  The date and time the footprint was generated, it will always be updated
#%part_name=pna4612m.fp;  Name of the part/footprint
...
#%column_spacing=2.54;  Spacing between columns
#%row_spacing=2.54;  Spacing between rows
...
#%pin_diameter=0.75;  The diameter of a pin in a through hole component
#%drill_bit=0.965;  The diameter of the drill for a via
#%annular_ring=1.473;  The diameter of the copper pad around the via
...
#%silk_left=4;  The offset of the silkscreen from the top of the footprint
