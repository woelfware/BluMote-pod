...
# Created on 02/08/11 at 22:14:13   For Kenneth Hutchins  < kenneth.hutchins@gmail.com > personal use
...
Element [ 0x0 "mcp1603t_tsot.fp"  "mcp1603t_tsot.fp"  ""  0  0  -11969   -11181   0   100   0x00 ] 
	(

	#Now adding Pads
	#Pad [rX1 rY1 rX2 rY2 Thickness Clearance Mask "Name" "Number" SFlags]

	Pad [ -787 	0 	787 	0 	2362 	1600 	3362 	"1"  	"1" 	 0x0100 ]
	Pad [ -787 	3740 	787 	3740 	2362 	1600 	3362 	"2"  	"2" 	 0x0100 ]
	Pad [ -787 	7480 	787 	7480 	2362 	1600 	3362 	"3"  	"3" 	 0x0100 ]
	Pad [ 8661 	7480 	10236 	7480 	2362 	1600 	3362 	"4"  	"4" 	 0x0100 ]
	Pad [ 8661 	0 	10236 	0 	2362 	1600 	3362 	"5"  	"5" 	 0x0100 ]

	#Now adding Silkscreen lines
	#ElementLine [X1 Y1 X2 Y2 Thickness] 

	ElementLine [ -1969 		-3181 		13417 		-3181 		1000 ]
	ElementLine [ -1969 		-3181 		-3969 		-1181 		1000 ]
	ElementLine [ -3969 		-1181 		-3969 		10661 		1000 ]
	ElementLine [ 13417 		-3181 		13417 		10661 		1000 ]
	ElementLine [ -3969 		10661 		13417 		10661 		1000 ]
...
#%date_generated=02/08/11   22:14:13;  The date and time the footprint was generated, it will always be updated
#%part_name=mcp1603t_tsot.fp;  Name of the part/footprint
...
#%columns=2;  Total number of columns in the footprint
...
#%column_spacing=2.40;  Spacing between columns
#%row_spacing=0.95;  Spacing between rows
...
#%pad_width=0.6;  The width of a copper pad
#%pad_length=1;  The length of a copper pad
...
#%notch=1;  The notch at the top of the round silkscreen border
