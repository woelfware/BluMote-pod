...
#Generated on 01/11/11 at 21:57:10
...
Element [ 0x0 "0805_resistor.fp"  "0805_resistor.fp"  ""  0  0  -12559   -11772   0   100   0x00 ] 
	(

	#Now adding Pads
	#Pad [rX1 rY1 rX2 rY2 Thickness Clearance Mask "Name" "Number" SFlags]

	Pad [ -787 	0 	787 	0 	3543 	1600 	4543 	"1"  	"1" 	 0x0100 ]
	Pad [ -787 	8661 	787 	8661 	3543 	1600 	4543 	"2"  	"2" 	 0x0100 ]

	#Now adding Silkscreen lines
	#ElementLine [X1 Y1 X2 Y2 Thickness] 

	ElementLine [ -4559 		-3772 		4559 		-3772 		1000 ]
	ElementLine [ -4559 		-3772 		-4559 		12433 		1000 ]
	ElementLine [ 4559 		-3772 		4559 		12433 		1000 ]
	ElementLine [ -4559 		12433 		4559 		12433 		1000 ]
...
#%date_generated=01/11/11   21:57:10;  The date and time the footprint was generated, it will always be updated
#%part_name=0805_resistor.fp;  Name of the part/footprint
...
#%column_spacing=1.8;  Spacing between columns
#%row_spacing=2.2;  Spacing between rows
...
#%pad_width=0.9;  The width of a copper pad
#%pad_length=1.3;  The length of a copper pad
