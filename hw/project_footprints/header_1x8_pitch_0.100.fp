...
# Created on 02/20/11 at 09:33:37   For Kenneth Hutchins  < kenneth.hutchins@gmail.com > personal use
...
Element [ 0x0 "header_1x8_pitch_0.100.fp"  "header_1x8_pitch_0.100.fp"  ""  0  0  -14000   -14000   0   100   0x00 ] 
	(
	...
	Pin [ 0 	60000 	8000 	1600 	9000 	4300 	"7"  	"7" 	 0x00 ]
	Pin [ 0 	70000 	8000 	1600 	9000 	4300 	"8"  	"8" 	 0x00 ]

	#Now adding Silkscreen lines
	#ElementLine [X1 Y1 X2 Y2 Thickness] 

	ElementLine [ -4000 		-6000 		6000 		-6000 		1000 ]
	ElementLine [ -4000 		-6000 		-6000 		-4000 		1000 ]
	ElementLine [ -6000 		-4000 		-6000 		76000 		1000 ]
	ElementLine [ 6000 		-6000 		6000 		76000 		1000 ]
	ElementLine [ -6000 		76000 		6000 		76000 		1000 ]
...
#%date_generated=02/20/11   09:33:37;  The date and time the footprint was generated, it will always be updated
#%part_name=header_1x8_pitch_0.100.fp;  Name of the part/footprint
...
#%rows=8;  Total number of rows in the footprint
#%columns=1;  Total number of columns in the footprint
#%total_pins=8;  Total number of pins in the footprint
